...
### Created by Carl McAlwane ( 1stcall ) on 2021-03-26
...
readonly script_author="carlmcalwane@hotmail.co.uk"
readonly script_created="2021-03-26"
...
show_usage() {
  ...
  out "Description: Testing bashew"
